...
class Product(models.Model):
    ...
    made_in = models.CharField(max_length=100, default='China')
...
class ProductAttribute(models.Model):
    ...
    attribute_type = models.ForeignKey(AttributeType, on_delete=models.CASCADE, related_name='attribute_types', default='1')
...
class Order(models.Model):
    ...
    promo_code = models.ForeignKey(PromoCode, on_delete=models.SET_NULL, null=True, related_name='promo_codes')
    full_name = models.CharField(max_length=100)
    phone_number = models.CharField(max_length=100)
    email = models.EmailField()
    comment = models.TextField()
    status = models.CharField(max_length=100, choices=StatusChoices.choices, default=StatusChoices.MODERATION)
...
class OrderProduct(models.Model):
    ...
    color = models.ForeignKey(ProductImage, on_delete=models.SET_NULL, null=True, blank=True, related_name='order_colors')
    memory = models.ForeignKey(Memory, on_delete=models.SET_NULL, null=True, blank=True, related_name='memory_products')

    def __str__(self):
        return f"{self.product.name} x{self.count}"

class Accessuary(models.Model):
    name = models.CharField(max_length=100)
    price = models.IntegerField()
    image = models.ImageField(upload_to='images/accessuary')
    description = models.TextField()
    category = models.ForeignKey(Category, on_delete=models.CASCADE, blank=True, null=True, related_name='category_accessuaries')
...
class ProductSet(models.Model):
    ...
    accessories = models.ManyToManyField(Accessuary, related_name='accessories')
...
class Cart(models.Model):
    product = models.OneToOneField(Product, on_delete=models.SET_NULL, null=True, related_name='cart_products')
